...
/**
 * @Description: Class pour une route
 * @Date: 2020年5月3日 上午8:54:12
 * @verson:1.0.0
 */
public class Tour implements Serializable {
    ...
    /**
     * @Description: générer une individuel(une nouvelle route) dant l'ordre de ville sont aléatoitre
     * @param:void
     * @return:la nouvelle tour
     */
...
//				this.cityList.set(i, city0);
	...
	/**
	 * @Description: générer une individuel(une nouvelle route) qui est dans le voisinage de mon Tour(cette méthode va être utilisé dans RS)
	 * @param: void
	 * @return: une Tour dans mon voisinage
	 */
...
//		int position2 = (int) ((this.cityList.size() - 1) * Math.random()) + 1;
    ...
    /**
     * @Description: calculer la distance totale de mon Tour
     * @param:void
     * @return: la distance
     */
	...
	/**
	 * @Description: justifier si mon Tour est égale à une autre Tour
	 * @param:un object(une Tour a priori)
